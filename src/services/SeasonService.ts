...
export const URL_SEASON = 'https://myanime-api.onrender.com/api/v1/seasons';
export const URL_LAST_SEASON = 'https://myanime-api.onrender.com/api/v1/animes/lastseason';
